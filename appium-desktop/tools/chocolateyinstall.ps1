...
$url        = 'https://github.com/appium/appium-desktop/releases/download/v1.2.7/appium-desktop-Setup-1.2.7.exe' # download url, HTTPS preferred
...
$packageArgs = @{
  ...
  softwareName  = 'Appium*' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
